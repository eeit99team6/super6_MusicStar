...
public class MusicController
{
    ...
    public String insertMusic(@RequestParam(value="music_description",required=false) String description,
	  ...
	  // ==================== musicLink =============================	
	    ...
	    String idNum = sdf.format(new java.util.Date().getTime());
		   ...
		   try
		   {
			musicLink.transferTo(new File(audiosDirectoryPath + memberLoginOk.getMbrId() +File.separator+ fileName_music_link));
		    bean.setMusic_link(Constant.audioDirectory + memberLoginOk.getMbrId() + File.separator + fileName_music_link);
    ...
    // ==================== musicPhoto =============================	
		...
		if(musicPhoto!=null){
		 ...
		 try
		   {
			 musicPhoto.transferTo(new File(coverDirectoryPath + memberLoginOk.getMbrId() + File.separator + fileName_music_photo));
		    bean.setMusic_photo(Constant.coverDirectory + memberLoginOk.getMbrId() + File.separator + fileName_music_photo);
